...
import { Menu, Rocket, Sparkles, Zap, Server, ChevronRight, Brain, Shield, TrendingUp, Workflow, Mail, MessagesSquare, MessageSquare, MessageCircle, Bell, Bot, CreditCard, Phone } from 'lucide-react';
...
function PlatformDropdown() {
  ...
  const MENU_ITEMS = [
  { name: 'Deliverability & Intelligence', desc: 'Advanced inbox placement and smart insights', icon: Shield, href: "/#deliverability" },
    { name: 'Reputation & Compliance Protection', desc: 'Safeguard sender reputation and ensure compliance', icon: Brain, href:"/#reputation" },
    { name: 'Journey & Engagement Intelligence', desc: 'Track customer journeys and optimize engagement', icon: TrendingUp, href: "/#journey" },
    { name: 'AI Intelligence & Precision Automation', desc: 'Smart automation powered by advanced AI', icon: Sparkles, href: "/#ai-intelligence" },
    { name: 'Developer Email Engine', desc: 'Powerful APIs for seamless integration', icon: Server, href: "/#developer-engine"},
    { name: 'Simple Transparent Pricing', desc: 'Clear pricing with no hidden costs', icon: Zap, href: "/#pricing" }
  ];
  ...
  return (
    ...
    >
      ...
      <div className={`absolute top-full left-1/2 -translate-x-1/2 mt-2 w-[700px] z-50 transition-all duration-300 ease-in-out ${
...
function PricingDropdown() {
  ...
  return (
    ...
    >
      ...
      {/* Dropdown Menu */}
      <div className={`absolute top-full left-1/2 -translate-x-1/2 mt-2 w-80 z-50 transition-all duration-300 ease-in-out ${
        isOpen ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 -translate-y-2 pointer-events-none'
      }`}>
        {/* Arrow */}
        <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-4 h-4 bg-zinc-900 border-t border-l border-zinc-800 rotate-45 z-50" />
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="font-bold text-2xl tracking-tight text-white -ml-4" style={{ fontFamily: "var(--font-funnel-display)" }}>
              Inwren
            </span>
          </Link>
